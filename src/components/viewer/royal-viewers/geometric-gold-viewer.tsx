    ...
    >
      ...
      >
                ...
                <div className="flex flex-col gap-6 my-8">
                  {flowData?.hostBrideFamily && (
                    <m.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="flex flex-col items-center">
                      ...
                      {flowData.hostBrideCity && <span className="text-xs mt-1 font-mono" style={{ color: getOpacityStyle('text', 0.6) }}>{s.translatedHostBrideCity || flowData.hostBrideCity}</span>}
                    </m.div>
                  )}
                  {flowData?.hostGroomFamily && (
                    <m.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className="flex flex-col items-center">
                      ...
                      {flowData.hostGroomCity && <span className="text-xs mt-1 font-mono" style={{ color: getOpacityStyle('text', 0.6) }}>{s.translatedHostGroomCity || flowData.hostGroomCity}</span>}
                    </m.div>
                  )}
                </div>
              )}
        ...
        <div className="py-10 text-center border-t" style={{ borderColor: getOpacityStyle('border', 0.1) }}>
          ...
          <p className="text-xs tracking-widest font-mono uppercase" style={{ color: getOpacityStyle('text', 0.4) }}>
