...
import {
  ...
  Copy, Check, LayoutDashboard, LogOut, Loader2, Crown, Sparkles,
} from "lucide-react";
...
export function DashboardPage({ flowData, onCreateNew, onViewInvitation, onSignOut }: DashboardPageProps) {
