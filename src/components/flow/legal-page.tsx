    ...
    sections: [
      {
        heading: "1۔ تعارف",
        content:
          "اسمارٹ انوائٹس میں خوش آمدید۔ اسمارٹ انوائٹس کی ملکیت اور انتظام TechyDez کے پاس ہے۔ ہماری سروس استعمال کر کے آپ ان شرائط و ضوابط کے پابند ہونے پر رضامندی دیتے ہیں۔ اسمارٹ انوائٹس پاکستانی شادیوں اور تقریبات کے لیے پریمیم ڈیجیٹل دعوت نامے فراہم کرتا ہے۔",
      },
      {
        heading: "2۔ اہلیت",
        content:
          "ہماری سروسز استعمال کرنے کے لیے آپ کی عمر کم از کم 18 سال ہونی چاہیے۔ اسمارٹ انوائٹس استعمال کر کے، آپ تصدیق کرتے ہیں کہ آپ کی عمر کم از کم 18 سال ہے اور آپ قانونی طور پر ان شرائط کو قبول کرنے کے اہل ہیں۔",
      },
      {
      ...
      },
      {
        ...
        content:
          "تمام ڈیزائنز، ٹیمپلیٹس اور کوڈ اسمارٹ انوائٹس کی ملکیت ہیں۔ آپ ہماری اجازت کے بغیر ہمارے ڈیزائنز کو دوبارہ فروخت یا کاپی نہیں کر سکتے۔",
      },
      {
      ...
      },
      {
        ...
        content:
          "یہ شرائط و ضوابط آپ اور ٹیک ڈیز (TechyDez - اسمارٹ انوائٹس کی پیرنٹ کمپنی) کے درمیان ایک قانونی معاہدہ ہیں۔ ہمارا رجسٹرڈ کاروباری پتہ جہلم، پنجاب، پاکستان ہے۔ یہ شرائط اسلامی جمہوریہ پاکستان کے قوانین کے تابع ہیں اور آپ اتفاق کرتے ہیں کہ کسی بھی تنازعے کی صورت میں جہلم کی عدالتوں کو خصوصی اختیار حاصل ہوگا۔",
      },
      {
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "اسمارٹ انوائٹس گوگل سائن ان کا استعمال جوڑوں کی شناخت کی تصدیق اور ان کا ڈیش بورڈ بنانے کے لیے کرتا ہے۔ آپ کے گوگل اکاؤنٹ کی تفصیلات (نام اور ای میل) صرف آپ کے دعوت ناموں کو محفوظ رکھنے اور ان میں تبدیلیاں کرنے کے لیے استعمال کی جاتی ہیں۔ ہم آپ کا گوگل ڈیٹا کسی کے ساتھ شیئر نہیں کرتے۔",
      },
      {
      ...
      },
      {
        ...
        content:
          "پیمنٹ کا عمل ہمارے مجاز پارٹنر، Safepay (Private) Limited کے ذریعے محفوظ طریقے سے سنبھالا جاتا ہے۔ اسمارٹ انوائٹس آپ کے کارڈ کی مکمل تفصیلات محفوظ نہیں کرتا۔ پیمنٹ کا ڈیٹا Safepay کی پرائیویسی پالیسی اور PCI-DSS معیارات کے مطابق پروسیس کیا جاتا ہے۔",
      },
      {
    ...
    sections: [
      {
        ...
        content:
          "اسمارٹ انوائٹس پر تمام خریداریاں حتمی ہیں۔ چونکہ ہماری سروس ڈیجیٹل پروڈکٹس اور ٹیمپلیٹس تک فوری رسائی فراہم کرتی ہے، اس لیے ہم سروس استعمال شروع کرنے کے بعد رقم واپس کرنے سے قاصر ہیں۔",
      },
      {
    ...
    sections: [
      {
        ...
        content:
          "اسمارٹ انوائٹس 100% ڈیجیٹل سروس ہے۔ آپ کے ایڈریس پر کوئی فزیکل پروڈکٹ، پرنٹ شدہ کارڈ، یا کوئی فزیکل سامان نہیں بھیجا جاتا۔",
      },
      {
      ...
      },
      {
        ...
        content:
          "چونکہ اسمارٹ انوائٹس صرف ڈیجیٹل پروڈکٹس فراہم کرتا ہے، اس لیے شپنگ کے کوئی چارجز یا ڈیلیوری میں تاخیر کا کوئی امکان نہیں ہے۔ سب کچھ سیکنڈوں میں آن لائن دستیاب ہے۔",
      },
    ],
  },
};
...
export function LegalPage({ type, onBack }: LegalPageProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <PageBreadcrumb
        crumbs={[
          { label: language === 'en' ? "Home" : "ہوم", href: "/", onClick: onBack },
          { label: data.title },
        ]}
      />
